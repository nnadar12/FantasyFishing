document.addEventListener('DOMContentLoaded', () => {
    ...
    // THE CHANGE: Updated event listener to call the backend API instead of the mock function
    getRegsBtn.addEventListener('click', async () => {
        ...
        try {
            // Fetch regulations from our new backend endpoint
            ...
            // Create a link to Google search for verification
    ...
    function createFeedItem(item, options = { showPoints: true }) {
        ...
        if (typeof item.likes === 'undefined') {
            item.likes = Math.floor(Math.random() * 150);
        }
